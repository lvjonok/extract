...
from extract.utils.eval_utils import ssim, psnr, mse
from extract.utils.general_utils import batchwise_index, AttrDict, timed, dict_concat
from extract.utils.vis_utils import make_gif_strip
...
class TopOfNEvaluator:
    ...
    def _erase_eval_buffer(self):
        ...
        self.batch_eval_buffer.aux_outputs = np.empty(self._hp.batch_size, dtype=np.dtype('O'))
