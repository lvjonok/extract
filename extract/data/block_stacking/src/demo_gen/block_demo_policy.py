...
from extract.utils.general_utils import AttrDict, split_along_axis
from extract.data.block_stacking.src.utils.utils import quat2euler
from extract.data.block_stacking.src.block_stacking_env import BlockStackEnv
...
if __name__ == "__main__":
    from extract.data.block_stacking.src.block_task_generator import (
