...
from extract.data.block_stacking.src.robosuite.wrappers import Wrapper
...
class IKWrapper(Wrapper):
    ...
    def __init__(self, env, action_repeat=1):
        ...
        if self.env.mujoco_robot.name == "sawyer":
            from extract.data.block_stacking.src.robosuite import SawyerIKController
            ...
            from extract.data.block_stacking.src.robosuite import BaxterIKController
