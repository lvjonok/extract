...
from extract.modules.layers import BaseProcessingNet, FCBlock
from extract.modules.losses import L2Loss
from extract.modules.variational_inference import stack
...
from extract.utils.general_utils import broadcast_final
...
class MLPLSTMCellInitializer(LSTMCellInitializer):
    ...
    def __init__(self, hp, cell, input_sz):
        ...
        from extract.modules.subnetworks import Predictor  # to avoid cyclic import
