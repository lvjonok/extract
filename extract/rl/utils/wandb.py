...
from extract.utils.general_utils import flatten_dict, prefix_dict
...
class WandBLogger:
    ...
    N_LOGGED_SAMPLES = 100 # make it basically infinite so all samples get logged

    def __init__(
        self, exp_name, run_group, project_name, entity, path, conf, exclude=None
    ):
        """
